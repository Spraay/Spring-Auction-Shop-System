...
import krystianrytel.sklepaukcyjny.repositories.RoleRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        krystianrytel.sklepaukcyjny.models.User user = userRepository.findByUsername(username);
        if (user == null) {
    ...
    private UserDetails createUserDetails(krystianrytel.sklepaukcyjny.models.User user) {
...
//        }
    ...
    @Override
    public void save(krystianrytel.sklepaukcyjny.models.User user) {
    ...
    @Override
    public krystianrytel.sklepaukcyjny.models.User getUser(String name){
